...
def manage_flashcards():
    ...
    if request.method == 'POST':
        ...
        incorrect_count = int(request.form.get('incorrect_count'))

        new_flashcard = {'term': term, 'meaning': meaning, 'incorrect_count': incorrect_count}
...
def start_review():
    # Begin review with the first flashcard
