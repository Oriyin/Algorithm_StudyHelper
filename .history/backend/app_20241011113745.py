...
# Route for managing flashcards (adding and listing)
...
def manage_flashcards():
    ...
    if request.method == 'POST':
        ...
        # Create a new flashcard with 'incorrect_count' initialized to 0
    ...
    # Render the flashcards page with the flashcards list
