...
# Route สำหรับการจัดการ flashcards
...
def manage_flashcards():
    ...
    if request.method == 'POST':
        ...
        # สร้าง flashcard ใหม่และตรวจสอบซ้ำ
...
# Route เมื่อการทบทวนเสร็จสิ้น
@app.route('/practice_completed')
def practice_completed():
    # แยก flashcards ที่ถูกและผิดออกมา
